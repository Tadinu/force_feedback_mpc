...
filename = DATA_SAVE_DIR + '_Fmin=' + str(FMIN) + '_Fmax=' + str(FMAX) + '_maxit=' + str(
    MAX_ITER_2) + '_fweight=' + str(FWEIGHT) + '_tol=1e-3.pkl'  # +'_fdotweight='+str(FDOTWEIGHT)+'.pkl'
...
# Save data 
NPZ_NAME = DATA_SAVE_DIR + '_Fmin=' + str(FMIN) + '_Fmax=' + str(FMAX) + '_maxit=' + str(
    MAX_ITER_2) + '_fweight=' + str(FWEIGHT) + '_tol=1e-3.npz'  # +'_fdotweight='+str(FDOTWEIGHT)+'.npz'
