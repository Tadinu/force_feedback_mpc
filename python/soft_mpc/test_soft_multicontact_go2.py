...
urdf_root_path = '/media/ducthan/376b23a1-5a02-4960-b3ca-24b2fcef8f891/10_IMPEDANCE_CONTROL/Go2Py/Go2Py/assets/'
urdf_path = '/media/ducthan/376b23a1-5a02-4960-b3ca-24b2fcef8f891/10_IMPEDANCE_CONTROL/Go2Py/Go2Py/assets/urdf/go2_with_arm.urdf'
...
for t in range(N_ocp + 1):
    ...
    # Stack models
    softContactModelsStack = ViscoElasticContact3d_Multiple(state, actuation,
    ...
    if t == N_ocp:
        forceCostManager = ForceCostManager([ForceCost(state, efId, np.array([-25, 0., 0.]), f_weight * dt, pinRef)],
                                            softContactModelsStack)
    else:
        forceCostManager = ForceCostManager([ForceCost(state, efId, np.array([-25, 0., 0.]), f_weight, pinRef)],
                                            softContactModelsStack)
