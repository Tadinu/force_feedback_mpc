...
from force_feedback_mpc.demos.polishing.polishing_classical_MPC import solveOCP
...
def main(SAVE_DIR, TORQUE_TRACKING):
    ...
    config = load_yaml_file(
        '/home/sebastien/workspace_seb/src/force-feedback/demos/sanding/config/iiwa_sanding_MPC.yml')
        ...
        for n_exp in range(N_EXP):
            ...
            for i in range(sim_data.N_simu):
                ...
                if (i % int(sim_data.simu_freq / sim_data.ctrl_freq) == 0):
                    ...
                    if (config['RICCATI']):
                        x_filtered = antiAliasingFilter.step(nb_ctrl, i, sim_data.ctrl_freq, sim_data.simu_freq,
                                                             sim_data.state_mea_SIMU)
