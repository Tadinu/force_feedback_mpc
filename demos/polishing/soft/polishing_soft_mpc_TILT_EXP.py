...
from force_feedback_mpc.demos.polishing.polishing_soft_mpc import solveOCP
...
def main(SAVE_DIR, TORQUE_TRACKING):
    ...
    config = load_yaml_file(
        '/home/sebastien/workspace_seb/src/force-feedback/demos/sanding/config/iiwa_aug_soft_sanding_MPC.yml')
    ...
    for n_seed in range(N_SEEDS):
        ...
        for n_exp in range(N_EXP):
            ...
            f_ext0 = [pin.Force.Zero() for _ in
                      robot.model.joints]  # pin_utils.get_external_joint_torques(contact_placement, f0, robot)
            ...
            for i in range(sim_data.N_simu):
                ...
                if (i % int(sim_data.simu_freq / sim_data.plan_freq) == 0):
                    ...
                    # Solve OCP 
                    solveOCP(q, v, f, solver, config['maxiter'], target_position, anchor_point, TASK_PHASE,
                             target_force)
