...
from force_feedback_mpc.soft_mpc.utils import SoftContactModel3D
...
# # # # # # # # # # # # # # # # # # # 
#  Read config file
config_name = 'force_tracking_soft_friction'
...
# Contact model
softContactModel = SoftContactModel3D(Kp=np.asarray(config['Kp']),
